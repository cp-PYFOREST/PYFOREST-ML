...
```{r}
# Data ---------------------------------------------------------
active_inactive_11 <- st_read("/Users/romero61/../../capstone/pyforest/ml_data/active_inactive_subsets/active_inactive_11.gpkg")
```
...
lup <- st_read("/Users/romero61/../../capstone/pyforest/data/permited_land_use/lup_gpkg/lup.gpkg", layer = "lup")
```

# Check CRS

```{r}
st_crs(active_inactive_11) 
...
```{r}
lup_w_categories_proj <- st_transform(lup, st_crs(active_inactive_11))
...
lup_active_11 <- lup_w_categories_proj %>% 
  filter(put_id %in% active_inactive_11$put_id) |>
...
st_write(lup_active_11,'/Users/romero61/../../capstone/pyforest/ml_data/lup_subsets/lup_11.gpkg')
```
